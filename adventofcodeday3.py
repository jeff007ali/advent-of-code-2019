...
line1 = populateGrid(wire1)
line2 = populateGrid(wire2)
...
def fewestSteps():
    steps = []
    for intersection in intersections:
        step = line1[intersection] + line2[intersection]
        steps.append(step)
    return min(steps)
